...
gkyl_gr_mhd_tetrad_max_abs_speed(double gas_gamma, const double q[71]);
...
GKYL_CU_D
static void
gr_mhd_tetrad_tetrad_wall(const struct gkyl_wv_eqn* eqn, double t, int nc, const double* skin, double* GKYL_RESTRICT ghost, void* ctx);
...
GKYL_CU_D
static void
gr_mhd_tetrad_tetrad_no_slip(const struct gkyl_wv_eqn* eqn, double t, int nc, const double* skin, double* GKYL_RESTRICT ghost, void* ctx);
