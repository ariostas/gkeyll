  ...
  if (spacetime_gauge == GKYL_STATIC_GAUGE) {
    ...
    for (int i = loidx_c; i<= upidx_c; i++) {
      ...
      if (evol_param > reinit_freq) {
        ...
        qnew[21] = extrinsic_curvature[0][0]; qnew[22] = extrinsic_curvature[0][1]; qnew[23] = extrinsic_curvature[0][2];
        qnew[24] = extrinsic_curvature[1][0]; qnew[25] = extrinsic_curvature[1][1]; qnew[26] = extrinsic_curvature[1][2];
        qnew[27] = extrinsic_curvature[2][0]; qnew[28] = extrinsic_curvature[2][1]; qnew[29] = extrinsic_curvature[2][2];
        ...
        qnew[31] = lapse_der[0]; qnew[32] = lapse_der[1]; qnew[33] = lapse_der[2];

        qnew[34] = shift_der[0][0]; qnew[35] = shift_der[0][1]; qnew[36] = shift_der[0][2];
        qnew[37] = shift_der[1][0]; qnew[38] = shift_der[1][1]; qnew[39] = shift_der[1][2];
        qnew[40] = shift_der[2][0]; qnew[41] = shift_der[2][1]; qnew[42] = shift_der[2][2];

        qnew[43] = spatial_metric_der[0][0][0]; qnew[44] = spatial_metric_der[0][0][1]; qnew[45] = spatial_metric_der[0][0][2];
        qnew[46] = spatial_metric_der[0][1][0]; qnew[47] = spatial_metric_der[0][1][1]; qnew[48] = spatial_metric_der[0][1][2];
        qnew[49] = spatial_metric_der[0][2][0]; qnew[50] = spatial_metric_der[0][2][1]; qnew[51] = spatial_metric_der[0][2][2];

        qnew[52] = spatial_metric_der[1][0][0]; qnew[53] = spatial_metric_der[1][0][1]; qnew[54] = spatial_metric_der[1][0][2];
        qnew[55] = spatial_metric_der[1][1][0]; qnew[56] = spatial_metric_der[1][1][1]; qnew[57] = spatial_metric_der[1][1][2];
        qnew[58] = spatial_metric_der[1][2][0]; qnew[59] = spatial_metric_der[1][2][1]; qnew[60] = spatial_metric_der[1][2][2];

        qnew[61] = spatial_metric_der[2][0][0]; qnew[62] = spatial_metric_der[2][0][1]; qnew[63] = spatial_metric_der[2][0][2];
        qnew[64] = spatial_metric_der[2][1][0]; qnew[65] = spatial_metric_der[2][1][1]; qnew[66] = spatial_metric_der[2][1][2];
        qnew[67] = spatial_metric_der[2][2][0]; qnew[68] = spatial_metric_der[2][2][1]; qnew[69] = spatial_metric_der[2][2][2];
